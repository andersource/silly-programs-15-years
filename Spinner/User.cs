...
namespace API
{
    ...
    partial class User
    {
        ...
        public static extern bool PrintWindow(HWND hWnd, HDC hDC, uint nFlags);
        [DllImport("user32")]
        ...
        [DllImport("user32")]
        public static extern int SendMessage(HWND hwnd, uint wMsg, IntPtr wParam, IntPtr lParam);
        [DllImport("user32")]
